...
<template>
    ...
    <div class="main-page-window">
            ...
            <div class="main-info">
                ...
                <div class="star-price-sum-order-fav">
                    <div class="star-price">
                        ...
                        <!-- Блок с оценкой -->
                        <p class="star">Оценка: 
                                    <img v-for="(star, index) in stars" :key="index" :src="star" alt="" width="20px" height="20px">
                        </p>

                        <!-- Блок с ценой -->
                        <div class="price">
                            <p>Цена: <span>{{ this.product.price }}</span> р</p>
                        </div>
                    </div>
        ...
        <div class="full-description" id="full-desc">
            <p><span>Полное описание товара: </span> {{ this.product.full_desctiption }}
